...
<head>
    ...
    <title>Manager Dashboard - SmartShop</title>
...
<body>
    ...
    <div class="sidebar">
        <div class="sidebar-header">
            ...
            <small class="text-white-50">Manager Panel</small>
        </div>
    ...
    <div class="main-content">
        <div class="d-flex justify-content-between align-items-center mb-4">
            <h1 class="h3 mb-0"><i class="bi bi-speedometer2"></i> Manager Dashboard</h1>
            ...
            <div class="col-md-4">
                <div class="stat-card product">
                    <div class="d-flex justify-content-between align-items-center">
                        <div>
                            <h6 class="mb-2">Tổng sản phẩm</h6>
        ...
        <div class="card mt-4">
            ...
            <div class="card-body">
                <div class="quick-actions">
                    <a href="${pageContext.request.contextPath}/admin/products?autoOpenModal=add" class="quick-action-btn">
                        <i class="bi bi-plus-circle"></i>
                        <div><strong>Thêm sản phẩm mới</strong></div>
                    </a>
                    <a href="${pageContext.request.contextPath}/admin/categories?autoOpenModal=add" class="quick-action-btn">
                        <i class="bi bi-plus-square"></i>
                        <div><strong>Thêm danh mục</strong></div>
                    </a>
